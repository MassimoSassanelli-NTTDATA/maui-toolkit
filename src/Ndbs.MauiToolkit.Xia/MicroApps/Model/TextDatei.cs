...
{
    /// <summary>
    /// A text (Text) file reference of a <see cref="Formular"/> (§5.3), analogous to
    /// <see cref="VervollstaendigungsDatei"/> but held in its own table. It keeps the
    /// file path, name and MIME type as well as the name of the dynamic content table
    /// created from the referenced CSV (§5.4).
    /// </summary>
    public sealed class TextDatei
    {
